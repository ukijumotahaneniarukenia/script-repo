...
mysql -uroot -pMysql3306 -Dtestdb -e 'source centos-7-6-18-10-healthcheck-mysql-8-X-X-mroonga-X-X-X.sql'


mysql -uuser01 -pMysql3306 -Dtestdb -e 'source centos-7-6-18-10-healthcheck-mysql-8-X-X-mroonga-X-X-X.sql'
